...
class LiquipediaDota2Provider(Dota2DataProvider):
    """Inactive Dota 2 Liquipedia provider awaiting approved LiquipediaDB documentation."""
    ...
    def _require_approved_match_api() -> NoReturn:
        # TODO(liquipedia-db): Add only approved Dota 2 LiquipediaDB endpoints and response
        # mapping after access is granted and its dashboard documentation is available.
        raise LiquipediaAccessRequiredError("LiquipediaDB access and documented Dota 2 match endpoints are required")
